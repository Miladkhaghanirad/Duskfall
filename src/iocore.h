...
enum class Sprite : unsigned short { DIFF_EASY = 0, DIFF_NORMAL = 2, DIFF_HARD = 4, LADY = 6, GENT = 8, ENBY = 10, CURSOR = 12, HEART_RED_1 = 14, HEART_RED_2 = 16, HEART_RED_3 = 18, HEART_RED_4 = 20, HEART_GREEN_1 = 38,
	HEART_GREEN_2 = 40, HEART_GREEN_3 = 42, HEART_GREEN_4 = 44, STATUS_BAR_FRAME_LEFT = 48, STATUS_BAR_FRAME_MID, STATUS_BAR_FRAME_RIGHT, UI_BOX_4, UI_BOX_5, UI_BOX_6, BAR_GREEN_1, BAR_GREEN_2, BAR_GREEN_3, BAR_GREEN_4,
	HEART_CONTAINER, HEART_CONTAINER_BLACK, HEART_BLUE_1 = 62, HEART_BLUE_2 = 64, HEART_BLUE_3 = 66, HEART_BLUE_4 = 68, UI_BOX_7 = 72, UI_BOX_8, UI_BOX_9, UI_BOX_1, UI_BOX_2, UI_BOX_3, BAR_BLUE_1, BAR_BLUE_2, BAR_BLUE_3, BAR_BLUE_4,
	HEART_BLACK_1 = 86, HEART_BLACK_2 = 88, HEART_BLACK_3 = 90, HEART_BLACK_4 = 92 };
...
#define SPRITE_FLAG_ANIMATED	(1 << 2)
